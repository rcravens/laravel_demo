    ...
    <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
        <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
            ...
            <main class="mt-6">
                ...
                <h1 style="color: white;font-size:48px;text-align:center;">Version: BBB</h1>
                    ...
                    <div class="flex flex-col items-start gap-6 overflow-hidden rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] md:row-span-3 lg:p-10 lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
                        <div class="relative overflow-x-auto">
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black dark:text-white">Random Coordinates: ({{$random_latitude}},{{$random_longitude}})</h2>

                                <p class="mt-4 text-sm/relaxed">
                                    The following are the 10 closest places to the random coordinates above.
                                </p>
                            </div>
                            <div class="pt-3 sm:pt-5">
                                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                    ...
                                    @foreach($places as $place)
                                        <tr class="border-b dark:border-gray-700 text-black dark:text-white">
                                            <td scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                {{ $place->name }}
                                            </td>
                                            <td class="px-6 py-80">
                                                {{number_format($place->distance_in_km)}}
                                            </td>
                                            <td class="px-6 py-4">
                ...
                <div class="rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] md:row-span-3 lg:p-10 lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
                        <div class="container mx-auto">
                            <div class="pt-3 sm:pt-5">
                                <h2 class=" w-full text-xl font-semibold text-black dark:text-white">Server Info</h2>
                            </div>
                            <div class="pt-3 sm:pt-5">
                                ...
                                <hr />
                                <div>
                                    <a style="float:right;" href="{{ url('/') }}?clear_cache=1">clear cache</a>
                                    <ul>
                                        @foreach($cached_ip_addresses as $host => $count )
                    ...
                    <div class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
                        ...
                        <div class="pt-3 sm:pt-5">
                            ...
                            <p class="mt-4 text-sm/relaxed">
                                ...
                                <a href="https://envoyer.io" class="rounded-sm underline hover:text-black focus:outline-none focus-visible:ring-1 focus-visible:ring-[#FF2D20] dark:hover:text-white">Envoyer</a>, and <a href="https://herd.laravel.com" class="rounded-sm underline hover:text-black focus:outline-none focus-visible:ring-1 focus-visible:ring-[#FF2D20] dark:hover:text-white">Herd</a> help you take your projects to the next level. Pair them with powerful open source libraries like <a href="https://laravel.com/docs/billing"
            ...
            <footer class="py-16 text-center text-sm text-black dark:text-white/70">
                Integrity Checker: {{$is_integrity_okay ? 'Pass' : 'Fail'}} | App Version: v{{env('APP_VERSION')}} | Laravel: v{{ Illuminate\Foundation\Application::VERSION }} | PHP: v{{ PHP_VERSION }} | Places: {{ count($places) . ' of ' . \App\Models\Place::count() }}
            </footer>
        </div>
    </div>
</div>
